...
Max Tillberg - Summer 2022, Summer 2025
Email: maxtillberg@hotmail.com
--------
Copyright (c) 2022-2025 Max Tillberg

Usage
    - Start IDA ICE 5.2 or later
    - In IDA ICE, Under Preferences - CAD Import, uncheck "Show this dialog before importing"
    - Save IDA ICE model as unpacked
    - Add path to IDA ICE model in ICE Bridge
    - Add path to IDA ICE folder in ICE Bridge
    - Select objects in Blender
    - Run script from ICE Bridge
2.0
    - Add inverted color scales for negative values
    - Bestäm namnstandard efter IFC
    CurtainWall642305IFCMEMBER#643469->Element=CurtainWall,IFCIDTillhörighet=642305,Component=IFCMEMBER,IFCID=#643469
    CAD objekt
    A0503-032-A-40-V-0001-IfcWall-PL11->IFC namn,Element,Story
    Cad geometri
    Wall Sweep:Tegelband 30mm:5269326->Object Type,ID
2.1 

    - Second try with sun path/sky globe with optional data
    
    - Test sum and mean value for zon import
    
    - Automaticlly add sensors and sensor data to zones on floors

    - Create windows and read data
    
    - Read building data into time charts
    - Test some consepts; sky domes shaped as sun paths, 
    
    - Create sun path (relevant sky patches, sky lines above , weather data if available
    - Plot data to suns, solar radiation direct and diffuce from result files
    - Setup loggning
    - Create wind rose
    
    - GROUP, THERMOSTAT_MIN, THERMOSTAT_MAX, CEILING-HEIGHT, ZONE-VOLUME, EXTSURF-AREA, FACADE-AREA
     Energy:
     (:PAR :N TAIRMIN :D NIL :V 20.98)
     (:PAR :N TAIRMAX :D "2025-08-25 10:35:06" :V 25.02 :IE 3965103306)
     (:PAR :N TOPMIN :D NIL :V 20.88)
     (:PAR :N TOPMAX :D "2025-10-06 14:18:18" :V 26.36 :IE 3968745498)
     (:PAR :N MAXHEATSUP :D "2025-01-08 03:17:45" :V 0.409 :IE 3945295065)
     (:PAR :N ROOMUNITHEAT :D "2025-01-08 03:12:31" :V 12.59 :IE 3945294751)
     (:PAR :N ROOMUNITHEATEN :V 64.323)
     (:PAR :N MAXHEATREM :D "2025-10-06 14:48:18" :V 63.32 :IE 3968747298)
     (:PAR :N ROOMUNITCOOL :D "2025-10-06 14:18:18" :V 40.72 :IE 3968745498)
     (:PAR :N ROOMUNITCOOLEN :V 192.1109)
     (:PAR :N DRYVENTCOOL :D "2025-06-11 18:09:54" :V 19.67 :IE 3958650594)
     (:PAR :N MAXSUPAIRFLOW :D "2025-01-09 21:17:48" :V 2.0262147269995 :IE 3945446268)
     (:PAR :N MAXEXHAIRFLOW :D "2025-01-09 21:47:48" :V 1.99699448989815)
     (:PAR :N MAXSOLAR :D "2025-10-06 12:48:18" :V 87.26 :IE 3968740098)
     (:PAR :N MINRELHUM :D NIL :V 5.699)
     (:PAR :N MAXRELHUM :D "2025-09-02 10:10:10" :V 62.16 :IE 3965793010)
     (:PAR :N MAXCO2 :D "2025-08-31 07:53:11" :V 540.7 :IE 3965611991)
     (:PAR :N MAXPPD :D "2025-01-08 00:25:26" :V 17.96 :IE 3945284726)
     (:PAR :N MAXAIRAGE :D "2025-08-31 07:53:11" :V 0.3627 :IE 3965611991)
     (:PAR :N OCCUPANCY :V 8760.0)
     (:PAR :N H_T_OP_LO :V 2358.89861111111 :IE 1053.72416666667)
     (:PAR :N H_T_OP_HI :V 0.0 :IE 0.0)
     (:PAR :N H_T_AIR_LO :V 600.06 :IE 4.46722222222222)
     (:PAR :N H_T_AIR_HI :V 0.0 :IE 0.0)
     (:PAR :N OCC_HOURS :V 5256)
     (:PAR :N PDH :V 433.3)
     (:PAR :N UNMET_HEAT :V 0.0)
     (:PAR :N UNMET_COOL :V 0.0)
     (:PAR :N TATMAXSUPAIRFLOW :V 16.99))
    
    
    - Read building information into building bodies
    - COUNTRY, CITY, LATITUDE, LONGITUDE, ELEVATION, TIME_ZONE 

    - Join groups when aggrigating
     
    - Give all objects custom property type, i.e. ICE Zone, ICE Building body, ICE Occupant, ICE Sensorpoint
    - Duplicated occupant geometry for faster reading
    - Import occupants from zones with properties

    - Import building bodies as geometries

    - Color ICE OBJ CAD objects according to data in ICE through their names in ICE
    
    - Read zone data into new object
    - Replace selected objects with other 3D objects
    - Att bara filer med valt namn läses in som VTK
    
    - Kunna skala om punkter och ge dem ny geometri
    - Valfri sökterm
    - Write building bodies and zones from Blender again together with glass generation script
    
    - More robust png names to avoid duplicated
    - Clean windows from panes as command
    - Test for Blender 4.5
    
    - Make wind rose based upon actual weather
    - Automaticly open ICE when a project is selected
    - Create complete scripts in ICE, i.e. convert objects to IFC, convert IFC to ICE, ...
    - Autocreate VTK
    - Autoconvert entire IFC to ICE
    - Autoconvert entire Speckle to ICE (Revit and ArchiCAD)
    - AutoConvert entire Revit (DEA) to ICE
    - Read building bodies
    - Perform glare studies via Radiance using cameras
2.2
...
bl_info = {
    ...
    'version': (2, 2, 0),
    'author': 'Max Tillberg',
    "doc_url": "https://github.com/max-tillberg/ICE-Bridge",
    'description': 'Export/import tool for IDA ICE',
}
...
#import csv #Used to read CSV-files with result data, for example prn and weather data
from mathutils import Matrix
from mathutils import Color #Used for expoerting images
...
#        max = 100
#        )
#    my_deleteCADbool: BoolProperty(
#        name = "Delete CAD file after import",
#        description="Delete CAD file after import",
#        default = False
#        )
...
#    )
    my_minvalue: FloatProperty(
        name = "Min",
        description="Min value of custom variable.",
        default = 0,
    )
    my_maxvalue: FloatProperty(
        name = "Max",
        description="Max value of custom variable.",
        default = 100,
    )
    ...
    my_colorscale: EnumProperty(
        ...
        items=[ ('BLUERED', "Blue-Red", "Blue to Red"),
                ...
                ('REDBLUE', "Red-Blue", "Red to Blue"),
                ('REDGREEN', "Red-Green", "Red to Green"),
                ('REDMAGENTA', "Red-Magenta", "Red to Magenta"),
               ]
        )
    my_timefilteroptions: EnumProperty(
        name="Time filter",
        description="Time filters",
        items=[ ('ENTIRE', "Entire simulation", "The entire simulation period"),
                ('SPRING', "Spring", "Mars-May"),
                ('SUMMER', "Summer", "June-August (northern hemisphere)"),
                ('AUTUMN', "Autumn", "September-November"),
                ('WINTER', "Winter", "January-Februaly, December"),
               ]
        )
...
#        default="C:\ICE File path\\",
#        maxlen=1024,
#        subtype='DIR_PATH'
#        )
    IDAICEfolder_path: StringProperty(
        name = "IDA ICE",
        description="Path to the directory where IDA ICE located",
        default="C:\Program Files (x86)\IDA ICE 5.2\\",
        maxlen=1024,
        subtype='DIR_PATH'
        )
...
#        )
    model_path: StringProperty(
        name = "Model",
        description="Choose an open unpacked IDA ICE model",
        default="C:\Filepath\\Unpacked IDA ICE model.idm",
        maxlen=1024,
        subtype='FILE_PATH'
        )
...
#        )
    my_filterlist: EnumProperty(
        ...
        items=[ ('IFCSpace', "IFCSpace", "IFCSpace", 'MOD_WIREFRAME', 0),
                ('Rooms', "Rooms", "Speckle Rooms collection", 'MOD_WIREFRAME', 1),
                ('IFCSpaceLongName', "IFCSpaceLongName", "Part of Longname in IfcSpace. Case sensitive", 'MOD_WIREFRAME', 2),
                
                ('IFCSlab', "IFCSlab", "IFCSlab", 'UGLYPACKAGE', 3),
                ('Floors', "Floors", "Speckle Floors collection", 'REMOVE', 4),
                
                ('IFCWall', "IFCWall", "IFCWall", 'MOD_BUILD', 5),
                ('Walls', "Walls", "Speckle Walls collection", 'MOD_BUILD', 6),
                
                ('IFCRoof', "IFCRoof", "IFCRoof", 'LINCURVE', 7),
                
                ('Windows', "Windows", "Speckle Windows collection", 'MOD_LATTICE', 8),
                ('IFCWindow', "IFCWindow", "IFCWindow", 'MOD_LATTICE', 9),
                ('WindowsCatagory', "Windows as category", "ICEExternalObjects", 'IMAGE_DATA', 10),
                ('WindowFamily', "Single Windows as family", "Window as family", 'IMAGE_DATA', 11),
                
                ('Curtain Panels', "Curtain Panels", "Speckle Curtain Panels collection", 'VIEW_ORTHO', 12),
                ('Curtain Systems', "Curtain Systems", "Speckle Curtain Systems collection", 'VIEW_ORTHO', 13),
                ('Panel', "Panel", "Panel", 'VIEW_ORTHO', 14),
                
                ('Glazed', "Glazed", "Glazed", 'IMAGE_DATA', 15),
                ('Glass', "Glass", "Glass", 'IMAGE_DATA', 16),
                ('Transparent', "Transparent objects", "Transparent Objects", 'MOD_WIREFRAME', 17),
                ('Glas as material', "Glas as material", "Glas as material", 'IMAGE_DATA', 18),
                
                ('IFCDoor', "IFCDoor", "IFCDoor", 'MATPLANE', 19),
                ('Doors', "Doors", "Speckle Doors collection", 'MATPLANE', 20),
                
                ('Cailings', "Ceilings", "Speckle Ceilings collection", 'NOCURVE', 21),
                ('Stairs', "Stairs", "Speckle Stairs collection", 'NLA_PUSHDOWN', 22),
                ('Railings', "Railings", "Speckle Railings collection", 'IPO_LINEAR', 23),
                ('IFCFurnishing', "IFCFurnishing", "IFCFurnishing", 'ASSET_MANAGER', 24),
                ('Proxy', "Proxy", "Proxy", 'QUESTION', 25),
                ('IFCSite', "IFCSite", "IFCSite", 'WORLD', 26),
                ...
                ('CustomProperty', "Custom variable", "Containing custom property", 'PRESET', 27),
                #('IceScale', "Color scale", "Color scale created with ICEBridge", 'COLORSET_02_VEC', 28),
                ('Font', "Texts", "Text (fonts)", 'OUTLINER_OB_FONT', 28),
                ('PropertyType', "Property type name", "The name of custom type ", 'PRESET', 29),
               ]
        )
    ...
    my_objectoperationlist: EnumProperty(
        ...
        items=[ #('CenterOfMass', "Set Origin to Center of Mass", "This is important to get midpoint of windows and doors correct", 'PIVOT_BOUNDBOX', 0),
                ('Isolate', "Isolate Selected Objects (Shift+H)", "Isolate Selected Objects", 'LIGHT_SUN', 0),
                #('Hide', "Hide Selected Objects (H)", "Hide Selected Objects", 'HIDE_ON', 2),
                ('Unhide', "Unhide Objects (Alt+H)", "Unhide Objects (Alt+H)", 'HIDE_OFF', 1),
                #('Show', "Show all Objects", "Show all Objects", 'HIDE_OFF', 3),
                ('Join', "Join Selected Objects (Ctrl+J)", "Join objects into the selected. Useful for complex building bodies, zones and external objects", 'OUTLINER_DATA_CURVE', 2),
                ('ColorObject', "Color Selected Object*", "Set Base Color and Transparency", 'COLORSET_01_VEC', 3),
                ('Duplicate', "Duplicate Selected Objects (Shift+D)", "Duplicate Selected Objects", 'DUPLICATE', 4),
                ...
                #('SortClockwise', "Sort vertices clockwise in selected objects", "Sort vertices clockwise. Important for zones and building bodies created from planes", 'MESH_DATA', 5),
                ...
                ('MakeNonSelectable', "Make Selected Objects non Selectable", "", 'RESTRICT_SELECT_ON', 5),
                ('MakeAllSelectable', "Make All Objects Selectable", "", 'RESTRICT_SELECT_OFF', 6),
                #('AlignObject', "Align selected object based upon surfaces", "Most be run in edit mode. Selct two faces", 'MOD_TRIANGULATE', 31),
                ('RandomColor', "Give selected objects random color", "Give selected objects random color", 'COLORSET_02_VEC', 7),
                ...
                ('ConvertFontToMesh', "Convert text to Mesh", "Convert text to Mesh. Useful for exporting to Speckle", 'OUTLINER_OB_FONT', 8),
                ...
                ('ClearMaterials', "Clear Materials of selected objects", "Clear Materials of selected objects. Useful for IFC", 'COLORSET_13_VEC', 9),
                ...
                ('DeleteSelectedObjects', "Delete selected objects", "Delete selected objects", 'REMOVE', 10),
               ]
        )
    ...
    my_exportobjectlist: EnumProperty(
        ...
        items=[ #('BuildingBodies', "Create Building bodies from volumes", "Volumes must be closed and made of planar surfaces. Each selected object will create one building body", 'HOME', 0),
                ...
                #('BuildingBodiesAndZones', "Create Building bodies and Zones from volumes", "Volumes must be closed and made of planar surfaces. Each selected object will create one building body and one zone", 'SNAP_VOLUME', 5),
                #('Windows', "Create Windows from large surfaces", "Windows should be as planar as possible", 'MOD_LATTICE', 6),
                ...
                #('FillWallsWithWindows', "Fill external Zone walls with Windows", "Useful if zones or building bodies represent windows", 'MOD_LATTICE', 7),
                #('Doors', "Create Doors from large surfaces", "Doors should be as planar as possible", 'MATPLANE', 8),
                ('ExternalObjects', "Export selected objects to IDA ICE", "Export selected objects as CAD objects and optionally CAD geometries if stored in system file", 'SCENE_DATA', 0),
                #('DeleteBuildingBodies', "Delete Building bodies", "Useful since building bodies are created automaticly when zones from OBJ volumes are created", 'TRASH', 10),
                #('DeleteZones', "Delete Zones", "Useful for temporary zones", 'TRASH', 11),
                #('HideObject', "Hide External Object", "This scales the named objects and affects result", 'HIDE_ON', 12),
                #('ShowObject', "Show External Obects", "This scales the named objects and affects result", 'HIDE_OFF', 13),
                #('MoveWindowsToBuildingbodies', "Move Windows from Zones to Building bodies", "", 'TRACKING_FORWARDS_SINGLE', 14),
                #('MoveWindowsToZones', "Move Windows from Buildingbodies to Zones", "", 'TRACKING_BACKWARDS_SINGLE', 15),
                #('CreateBoundingBox', "Creating Bounding Box Building body", "Useful to avoid created objects in origo", 'SNAP_FACE_CENTER', 16),
                #('MoveZonesZ', "Move Zones Given Distance in Z", "Move Zones Given Distance in Z", 'SORT_DESC', 16),
                #('MoveBuildingBodiesZ', "Move Buiding Bodies Given Distance in Z", "Move Buiding Bodies Given Distance in Z", 'SORT_DESC', 17),
                #('CreateICESensors', "Create Sensors", "Based upon objects with ICEname", 'LIGHTPROBE_GRID', 18),
                #('RunHeatingLoadSimulation', "Run Heating load simulation", "Require special agreement with Equa to use", 'PLAY', 15),
                ('SetupForLogging', "Setup seleted IDA ICE file for logging", "Loggs a lot of things.", 'SORT_DESC', 1),
               ]
        )
    my_postprocesslist: EnumProperty(
        ...
        items=[ #('CreatePointCSV', "Create Point CSV ", "Fom idm or H5. DF, Point Illuminance. Tricky, needs to be flexible and support different formats", 'MESH_CUBE', 0),
                ...
                ('CreteRoomShape', "Import zones",  "Create mesh with data for each zone and occupants", 'MESH_CUBE', 0),
                #('CreateBuildingModel', "Crete Building Model", "Illustration to log systems and energy result upon", 'MESH_CUBE', 3),
                ('CreatePointsFromVTK', "Import VTK result", "Create mesh with data for each point in VTK-file in folder", 'DISC', 1),
                ...
                ('ColorAccordingToProperty', "Color Selected Objects According To Variable", "Color scale, max, min, type", 'COLORSET_02_VEC', 2),
                ('TextAccordingToProperty', "Text Selected Objects According To Variable", "Text According To Variable", 'FILE_TEXT', 3),
                #('AutoScaleColorScale', "Autoscale color scale", "Set min and max according to selected objects", 'FILE_TEXT', 10),
                #('CreateShapes', "Create Shapes from exported VTK", "Create shapes from exported VTK", 'MESH_CYLINDER', 11),
                ('AggregatePoints', "Aggregate Selected Points to New Shape", "Creates a new shape at median point with aggregated values", 'STICKY_UVS_LOC', 4),
                #('AggregatePoints2Zones', "Aggregate Points to Zones", "Saved to zones with aggregated values", 'STICKY_UVS_LOC', 5),
                # ('CalculateDGP', "Caculate glare for all cameras", "Calculates luminance and DGP for all cameras", 'STICKY_UVS_LOC', 5),
                ('CreateSunPath', "Create sun paths", "Create sun paths with optional weather data if selected temp folder", 'STICKY_UVS_LOC', 6),
                ('CreateSkyDome', "Create sky dome", "This could be very slow", 'STICKY_UVS_LOC', 7),
                ('CreateDayChart', "Import selected zones with selected variable", "Create dayly clock chart with radius", 'STICKY_UVS_LOC', 8),
               ]
        )
...
#                obj["ICEGroup"] = str(obj["ICEGroup"]) + "_" + str(mytool.groupname)
        ...
        if mytool.my_objectoperationlist == "DeleteSelectedObjects":
...
class WM_OT_Export(Operator):
    ...
    bl_description = "Create files and run script"
...
#            scriptname = "ImportDoors"
        ...
        if mytool.my_exportobjectlist == "SetupForLogging":
            scriptname = "SetupForLogging"
...
#            return {'FINISHED'}
        ...
        #parent = os.path.dirname(tempfile_path)
        ICEScript = open(str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '\\' + scriptname + '.txt','w')
...
#        if mytool.my_exportobjectlist == "Sunpath":
            #bpy.context.scene.sun_pos_properties.time = bpy.context.scene.sun_pos_properties.time + 1
            #bpy.context.object.location[0]
            #Generate once per hour for 15 each month
        if mytool.my_exportobjectlist == "SetupForLogging":
            #Set up model so it saves relavant data fro postprocessing
            ICEScript.write('(:SET doc_ (:call get-document "' + str(bpy.path.abspath(mytool.model_path)) + '"))' +'\n')
            ICEScript.write('(:UPDATE [doc_] ' +'\n')
            ICEScript.write("((SIMULATION_DATA :N SIMULATION_DATA)((SIMULATION_PHASE :N CALCULATION-PHASE)(:PAR :N OUTPUT-STEP :V 0 :S '(:DEFAULT NIL 2))))" +'\n')
            ICEScript.write("((AGGREGATE :N SYSPARS)(:PAR :N DAYLIGHT_AT :V FLOOR :S '(:DEFAULT NIL 2))(:PAR :N SCHEDULE_SMOOTHING_FANOUT :V 0 :S '(:DEFAULT NIL 2)))" +'\n')
            ICEScript.write("((AH-MACRO :N AHU)" +'\n')
            ICEScript.write("(:ADD (:CEO :SYMBOL '(:AT ((572 197)) :R (20 18) :ICON "+'"lib:climate.ids"'+' :SLOT ("CLIMATE") :NAME "CLIMATE" :PADDING 3 :DATA :CEO) :N "CLIMATE" :T ENVIRONMENT)'+'\n')
            ICEScript.write('(:VAR :N ELEVSUN :L "ICEBridge logging" :AS "SunElevation")' +'\n')
            ICEScript.write('(:VAR :N AZIMUTSUN :L "ICEBridge logging" :AS "SunAzimut")' +'\n')
            #ICEScript.write("(:VAR :N XAIR :B :IV :S '(1 T 2 * (SYSPARS CO2_AMBIENT) 1.52))" +'\n')
            ICEScript.write('(:VAR :N WINDX :L "ICEBridge logging" :AS "WindX")' +'\n')
            ICEScript.write('(:VAR :N WINDY :L "ICEBridge logging" :AS "WindY")' +'\n')
            ICEScript.write('(:VAR :N IDIRNORM :L "ICEBridge logging" :AS "IDirNorm")' +'\n')
            ICEScript.write('(:VAR :N IDIFFHOR :L "ICEBridge logging" :AS "IDiffHor"))' +'\n')
            ICEScript.write('(:ADD OUTPUT-FILE :SF "self:\\ICEBridge_logging.prn" :N "ICEBridge logging" :T OUTPUT-FILE :COL T))' +'\n')
            ICEScript.write('((OUTPUT-CONTROL :N OUTPUT)' +'\n')
            ICEScript.write("(:PAR :N COMFORT_INDICES :V :TRUE :S '(:DEFAULT NIL 2))" +'\n')
            ICEScript.write("(:PAR :N IAQ :V :TRUE :S '(:DEFAULT NIL 2))" +'\n')
            ICEScript.write("(:PAR :N LIGHT_COND :V :TRUE :S '(:DEFAULT NIL 2))" +'\n')
            ICEScript.write("(:PAR :N GSYST-FACE-RAD :V :TRUE :S '(:DEFAULT NIL 2))" +'\n')
            ICEScript.write("(:PAR :N GSYST-WIN_QSOLAR :V :TRUE :S '(:DEFAULT NIL 2))" +'\n')
            ICEScript.write("(:PAR :N SHADINGON :V :TRUE :S '(:DEFAULT NIL 2))" +'\n')
            ICEScript.write("(:PAR :N ZONE-OCCUPANCY :V :TRUE :S '(:DEFAULT NIL 2))" +'\n')
            ICEScript.write("(:PAR :N SENSOR-SIGNALS :V :TRUE :S '(:DEFAULT NIL 2)))" +'\n')
            ICEScript.write(')')
        if mytool.my_exportobjectlist == "ExternalObjects": #All selected meshes should be grouped
            ...
            if fn == "":
                fn = fn + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(6)) #Add random 6 digit name if empty
            fnorg = fn  #+ str(mytool.groupname) #save the zone name for later
            shadename = (str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '\\' + str(fnorg)) #Get path
            if str(mytool.my_fileformatlist) == "OBJ":
                fp = shadename  + '.obj'
                # Give name according to selected filter plus a random string
                bpy.ops.wm.obj_export(filepath=fp, check_existing=True, forward_axis='Y', up_axis='Z', export_selected_objects=True, export_uv=True, export_normals=True, export_colors=False, export_materials=True, export_triangulated_mesh=False, export_object_groups=False, export_material_groups=False, filter_glob='*.obj;*.mtl')
                #Write the script
                ICEScript.write('(:SET doc_ (:call get-document "' + str(bpy.path.abspath(mytool.model_path)) + '"))' +'\n')
                ICEScript.write('(ice-add-pict-file (:call ice-3d-pane [doc_] t t)  "' + fp + '"'+" (:call list nil nil (:call get-value [doc_] " + "'" + "(defaults current_floor_level))))")
#            if str(mytool.my_fileformatlist) == "DXF":
#                fp = shadename  + '.dxf'
#                #Write the script
#                bpy.ops.export_scene.dxf(filepath=fp, axis_forward='Y', axis_up='Z', use_selection=True, check_existing=True)
#                ICEScript.write('(:SET doc_ (:call get-document "' + str(bpy.path.abspath(mytool.model_path)) + '"))' +'\n')
#                ICEScript.write('(ice-add-pict-file (:call ice-3d-pane [doc_] t t)  "' + fp + '"'+" (:call list nil nil (:call get-value [doc_] " + "'" + "(defaults current_floor_level))))")
            if str(mytool.my_fileformatlist) == "3DS":
                fp = shadename  + '.3ds'
                #Write the script
                bpy.ops.export_scene.max3ds(filepath=fp, axis_forward='Y', axis_up='Z', use_selection=True, check_existing=True)
                ICEScript.write('(:SET doc_ (:call get-document "' + str(bpy.path.abspath(mytool.model_path)) + '"))' +'\n')
                ICEScript.write('(ice-add-pict-file (:call ice-3d-pane [doc_] t t)  "' + fp + '"'+" (:call list nil nil (:call get-value [doc_] " + "'" + "(defaults current_floor_level))))")
            if str(mytool.my_fileformatlist) == "PNG":
                #Gå igenom alla valda objekt
                #Skapa en bild med insättningspunkt, färg och ev storlek men namn som har bra värde, t.ex. 
                size =[10,10]
                ...
                for obj in selection:
                    obj.select_set(True)
                    custompropertyexists = bpy.data.objects[str(obj.name)].get('Result') is not None
                    if custompropertyexists == True:
                        fp = shadename + "_" + (str(bpy.data.objects[str(obj.name)]['Result'])) + '.png'
                    ...
                    for x in range(size[0]):
                        for y in range(size[1]):
                            ...
                            r = float(bpy.data.objects[str(obj.name)]['ZR']) #x / size[0]
                            g = float(bpy.data.objects[str(obj.name)]['ZG']) #y / size[1]
                            b = float(bpy.data.objects[str(obj.name)]['ZB']) #(1 - r) * g
                            a = 1.0
                    ...
                    image.save()
                    #Write the script
                    ICEScript.write('((AGGREGATE :N ARCDATA)((AGGREGATE :N "' + str(bpy.data.objects[str(obj.name)]['Result']) + '" :T PICT2D)(:PAR :N PATH :V "' + fp + '")(:PAR :N ORIGIN :V #(' + str(obj.location[0] - mytool.my_size / 2) + ' ' + str(obj.location[1] - mytool.my_size / 2) + ' ' + str(obj.location[2]) + '))(:PAR :N SIZE :V #(' + str(mytool.my_size) + ' ' + str(mytool.my_size) + ' 1.5))))')
                ICEScript.write(')')
        ICEScript.close()
        # Replace  \ with \\
        # Read in the file
        with open(str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '\\' + scriptname + '.txt', 'r') as file :
          filedata = file.read()
        # Replace the target string
        filedata = filedata.replace("\\", "\\\\")
        # Write the file out again
        with open(str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '\\' + scriptname + '.txt', 'w') as file:
          file.write(filedata)
        ICEScript.close()
...
#                        file.write(filedata)
        ...
        if mytool.model_path == "": # and mytool.my_exportobjectlist == "ExternalObjects":
            ...
            return {'FINISHED'}
        #Create Bat-file
        Tempbatfile = str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '\\' + scriptname + '.bat'
        BATFile=open(Tempbatfile,'w')
        BATFile.write('"' + str(bpy.path.abspath(os.path.dirname(mytool.IDAICEfolder_path))) + '\\bin\ice.exe"' + ' -X "' + str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '\\' + scriptname +'.txt' + '"')# + '\n' + 'Del ' + str(Tempbatfile))
        BATFile.close()
        #Edit Script so it can be run from BAT-file
#        new_content = '(:SET doc_ (:call get-document "' + str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '"))'
...
#       #Run the BAT-file
        ...
        #Delete Script and BAT file and optionally CAD
        #os.remove(Tempbatfile)
        return {'FINISHED'}
...
#            #    bpy.context.scene.collection.objects.link(obj)
        if mytool.my_postprocesslist == "CreteRoomShape":
            with open(mytool.model_path, 'r') as f:
                for line in f:
                    if 'CE-ZONE' in line:
                        tempzonename = line.split('"')[1::2]
                        tempzonename = tempzonename[0]
                        tempfilename = os.path.basename(mytool.model_path)
                        tempfilename = os.path.splitext(tempfilename)[0]
                        zonefilepath = os.path.dirname(mytool.model_path) + '/' + tempfilename + '/' + str(tempzonename) + ".idm"
                        with open(zonefilepath, 'r') as f:
                            zonetempZ = 0 #If missing , the default is 0
                            zonetemporientation = 0 #If missing , the default is 0
                            foundcorners = False #We should just find one set of corners, the first
                            foundoccupants = False #Just read occupant position
                            occupantnumber = 0
                            occupants = []
                            occupantsX = []
                            occupantsY = []
                            ...
                            for line in f:
                                if 'ORIGIN' in line:
                                    ...
                                    zonetempX = float(templine[0])
                                    zonetempY = float(templine[1])
                                if 'CORNERS' in line:
                                    if foundcorners == False:
                                        templine = line.split("#2A",1)[1] # Check complex zones in future versions
                                        templine = templine.replace(")))", "))")
                                        templine = templine.replace(")", "]")
                                        templine = templine.replace("(", "[")
                                        templine = templine.replace(" ", ",")
                                        ...
                                        templine = templine.replace(", ]]", "]]")
                                        faces = eval(templine)
                                    foundcorners = True # Do not read any more corners
                                if 'ORIENTATION' in line:
                                    templine = line.split("V ",1)[1]
                                    templine = templine.replace(")", "")
                                    zonetemporientation = float(templine)
                                if 'ZONE-VOLUME' in line:
                                    templine = line.split("V ",1)[1]
                                    templine = templine.replace(")", "")
                                    zonetempvolume = float(templine)
                                if 'EXTSURF-AREA' in line:
                                    templine = line.split("V ",1)[1]
                                    templine = templine.replace(")", "")
                                    zonetempExtSurfArea = float(templine)
                                if 'FACADE-AREA' in line:
                                    templine = line.split("V ",1)[1]
                                    templine = templine.replace(")", "")
                                    zonetempExtFacadeArea = float(templine)
                                if 'FLOOR_HEIGHT_FROM_GROUND' in line:
                                    templine = line.split("V ",1)[1]
                                    templine = templine.split(") ",1)[0]
                                    templine = templine.replace(")", "")
                                    zonetempZ = float(templine)
                                if 'OCCUPANT' in line:
                                    foundoccupants = True
                                    templine = line.split('"',1)[1] # Asumes that zones have occupants
                                    templine = templine.replace('"', "")
                                    occupants.append(templine)
                                    occupantsX.append(0) #Give default values in midpoint since this might be the default value
                                    occupantsY.append(0)
                                    occupantsZ.append(0.6)
                                if 'EQUIPMENT' in line:
                                    foundoccupants = False #To know that it is equipment and not occupants
#                                    templine = line.split('"',1)[1] # Asumes that zones have occupants
#                                    templine = templine.replace('"', "")
#                                    occupants.append(templine)
#                                    occupanttempX = 1
#                                    occupanttempY = 1
#                                    occupanttempZ = 0
#                                    occupanttemporientation = 0
                                if 'POSITION' in line:
                                    if foundoccupants == True:
                                        templine = line.split('#(',1)[1]
                                        templine = templine.replace(')))', "")
                                        templine = templine.replace(')', "")
                                        occupantsX[occupantnumber] = (templine.split(" ")[0])
                                        occupantsY[occupantnumber] = (templine.split(" ")[1])
                                        occupantsZ[occupantnumber] = (templine.split(" ")[2])
                                        occupantnumber = occupantnumber + 1
                            #Create zone meshes
                            mesh = bpy.data.meshes.new("myZoneMesh")  # Add the new mesh
                            obj = bpy.data.objects.new(mesh.name, mesh)
                            col = bpy.data.collections["Collection"]
                            col.objects.link(obj)
                            bpy.context.view_layer.objects.active = obj
                            mesh.from_pydata(verts, edges, faces)
                            bpy.context.active_object.name = str(tempzonename) #Give the meash same name as zone
                            #bpy.context.active_object["FirstRow"] = str(tempzonename) #Give the meash same name as zone
                            bpy.context.active_object["ObjectType"] = "ImportedICEZone"
                            bpy.context.active_object["Zone volume"] = zonetempvolume
                            bpy.context.active_object["External surface area"] = zonetempExtSurfArea
                            bpy.context.active_object["Facade area"] = zonetempExtFacadeArea

                            bpy.context.active_object.location[0] = zonetempX
                            bpy.context.active_object.location[1] = zonetempY
                            bpy.context.active_object.location[2] = zonetempZ
                            #zonetemporientation = 45
                            bpy.context.active_object.rotation_euler = (0,0,math.radians(zonetemporientation))
                            #Create occupant meshes
                            for i in range(0, len (occupants)):
                                if float(occupantsZ[i]) <= 1.4:
                                    bpy.ops.wm.obj_import(filepath =  str(bpy.path.abspath(os.path.dirname(mytool.IDAICEfolder_path))) + '\\Samples\\3d_objects\manequin-sitting.obj', forward_axis='Y', up_axis='Z')
                                    bpy.context.active_object.rotation_euler = (0,0,math.radians(270))
                                elif float(occupantsZ[i]) > 1.4:
                                    bpy.ops.wm.obj_import(filepath =  str(bpy.path.abspath(os.path.dirname(mytool.IDAICEfolder_path))) + '\\Samples\\3d_objects\manequin-standing.obj', forward_axis='Y', up_axis='Z')
                                    #bpy.ops.wm.obj_import(filepath='C:\Program Files (x86)\IDA ICE 5.2\Samples\\3d_objects\manequin-standing.obj', forward_axis='Y', up_axis='Z')
                                bpy.context.active_object.name = str(tempzonename) + "_" + str(occupants[i])
                                bpy.context.active_object.location[0] = float(occupantsX[i])
                                bpy.context.active_object.location[1] = float(occupantsY[i])
                                bpy.context.active_object.location[2] = 0 #float(occupantsZ[i]) #Alltid 0
                                #if os.path.exists(file_path):
                                #Add camera
                                if float(occupantsZ[i]) <= 1.4: #Z adapted to OBJ
                                    bpy.ops.object.camera_add(enter_editmode=False, align='VIEW', location=(-0.35, 0, 1.4), rotation=(math.radians(90), 1.68714e-09, math.radians(-90)))
                                elif float(occupantsZ[i]) > 1.4:
                                    bpy.ops.object.camera_add(enter_editmode=False, align='VIEW', location=(0, -0.15, 1.72), rotation=(math.radians(90), 1.68714e-09, math.radians(-180)))
                                bpy.context.active_object["ObjectType"] = "Camera"
                                bpy.context.active_object.name = str(tempzonename) + "_" + str(occupants[i]) + "_camera"
                                #Set relations between occupant and cammera and occupant and zone
                                objects = bpy.data.objects
                                a = objects[str(tempzonename) + "_" + str(occupants[i])]
                                b = objects[str(tempzonename) + "_" + str(occupants[i]) + "_camera"]
                                b.parent = a
                                objects = bpy.data.objects
                                a = objects[str(tempzonename)]
                                b = objects[str(tempzonename) + "_" +str(occupants[i])]
                                b.parent = a
        if mytool.my_postprocesslist == "CreatePointsFromVTK":
            for vtkfiles in os.listdir(os.path.dirname(mytool.model_path)): #Check name
                if vtkfiles.endswith(".vtk"): #Read file                
                    vtkpath = os.path.dirname(mytool.model_path) + '/' + vtkfiles
                    #readpoints = True
                    #Make 5 lists with data
                    PointX = []
                    PointY = []
                    PointZ = []
                    PointConnections = []
                    PointResult = []
                    #temppoint = 0
                    readstate = "None" #"Points", "CONNECTIVITY, "POINT_DATA" #Var i textfilen man är
                    with open(vtkpath, 'r') as f:
                        for line in f:
                            if 'POINTS' in line:
                                readstate = "Points"
                                continue
                            if line == '\n' or 'METADATA' in line or 'POINT_DATA' in line:
                                readstate = "None"
                                continue
                            if 'CONNECTIVITY' in line:
                                readstate = "CONNECTIVITY"
                                continue
                            if 'LOOKUP_TABLE' in line:
                                readstate = "LOOKUP_TABLE"
                                continue
                            if readstate == "Points":
                                for i in range(0, len(line.split()), 3): #Points are in groups of three
                                    point = line.split()[i:i + 3]
                                    PointX.append(float(point [0]))
                                    PointY.append(float(point [1]))
                                    PointZ.append(float(point [2]))
                                    PointConnections.append(0) #Make sure that the list have the right length and only contains 0
                            elif readstate == "CONNECTIVITY":#ta på vilka punkter som skall ignoreras genom att lagra kopplingar till andra punkter
                                for i in line.split():
                                    #tempvalue = int(PointConnections[int(i)])
                                    #tempvalue = tempvalue + 1
                                    PointConnections[int(i)] = PointConnections[int(i)] + 1
                            elif readstate == "LOOKUP_TABLE":
                                for i in line.split():
                                    PointResult.append(i)
                    #Create a tenplate object point to duplicate and give it some basic properties
                    #Create an object to store values on
                    if str(mytool.my_shapelist) == "Plane":
                        bpy.ops.mesh.primitive_plane_add(size = float(mytool.my_size))
                    elif str(mytool.my_shapelist) == "Cube":
                        bpy.ops.mesh.primitive_cube_add(size = float(mytool.my_size))
                    elif str(mytool.my_shapelist) == "Sphere":
                        bpy.ops.mesh.primitive_uv_sphere_add(radius = (float(mytool.my_size) / 2))
                    elif str(mytool.my_shapelist) == "Cylinder":
                        bpy.ops.mesh.primitive_cylinder_add(radius = (float(mytool.my_size) / 2), depth=0.01)  
                    #bpy.ops.mesh.primitive_plane_add(size=0.25, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(1, 1, 1))
                    bpy.context.active_object.name = 'VTK Point'
                    bpy.context.active_object["FirstRow"] = "VTK template" #Ge alla 0 kopplingar initialt
                    bpy.context.active_object["SecondRow"] = "Zone Group" #Ge alla 0 kopplingar initialt
                    bpy.context.active_object["ZR"] = 0
                    bpy.context.active_object["ZG"] = 0
                    bpy.context.active_object["ZB"] = 0
                    bpy.context.active_object["Result"] = 0
                    C = bpy.context
                    src_obj = bpy.context.active_object
                    #Create meshes depending on number of connections
                    for i in range(len(PointX)):
                        if int(PointConnections[i]) > 3 and int(PointConnections[i]) < 7:
                            new_obj = src_obj.copy()
                            new_obj.data = src_obj.data.copy()
                            new_obj.animation_data_clear()
                            C.collection.objects.link(new_obj)
                            new_obj["FirstRow"] = "Zone Name"
                            new_obj["SecondRow"] = "Zone Group"
                            #new_obj["Connections"] = int(PointConnections[i])
                            new_obj["Result"] = float(PointResult[int(i)])
                            new_obj.location[0] = float(PointX [i])
                            new_obj.location[1] = float(PointY [i])
                            new_obj.location[2] = float(PointZ [i])
        if mytool.my_postprocesslist == "ColorAccordingToProperty":
            ...
            for obj in bpy.context.selected_objects:
                if str(mytool.custompropertyname) in obj:
                    ...
                    elif str(mytool.my_colorscale) == "REDBLUE":
                        tempcolor =  (pseudocolor(tempvalue, float(mytool.my_minvalue), float(mytool.my_maxvalue), RED, BLUE))
                    elif str(mytool.my_colorscale) == "REDMAGENTA":
                        tempcolor =  (pseudocolor(tempvalue, float(mytool.my_minvalue), float(mytool.my_maxvalue), RED,MAGENTA))
                    #Create a new material for each object
                    tempmaterial = bpy.data.materials.new(str(tempcolor))
                    #Save colors as properties as weel for easy access
                    obj["ZR"] = tempcolor[0]
                    obj["ZG"] = tempcolor[1]
                    obj["ZB"] = tempcolor[2]
        ...
        if mytool.my_postprocesslist == "TextAccordingToProperty":
            ...
            for obj in bpy.context.selected_objects:
                ...
                if str(mytool.custompropertyname) in obj:
                    ...
                    # -- Set scale and location
                    textobj.location = (centre.x, centre.y, centre.z + 0.05)
...
#                bpy.context.scene.collection.objects.link(obj)
        if mytool.my_postprocesslist == "AggregatePoints":
            #Aggregate selected points, find position
            templist = []
            tempx = 0
            tempy = 0
            tempz = 0
            for obj in bpy.context.selected_objects:
                if str(mytool.custompropertyname) in obj:
                    ...
                    tempx = obj.location[0] + tempx
                    tempy = obj.location[1] + tempy
                    tempz = obj.location[2] + tempz
            tempx = tempx / len(templist)
            tempy = tempy / len(templist)
            tempz = (tempz / len(templist)) + 0.05 #Alltid 5cm ovan
            ...
            #Create an object to store values on
            if str(mytool.my_shapelist) == "Plane":
                bpy.ops.mesh.primitive_plane_add(location = (tempx,tempy,tempz), size = float(mytool.my_size))
            elif str(mytool.my_shapelist) == "Cube":
                bpy.ops.mesh.primitive_cube_add(location = (tempx,tempy,tempz), size = float(mytool.my_size))
            elif str(mytool.my_shapelist) == "Sphere":
                bpy.ops.mesh.primitive_uv_sphere_add(radius = (float(mytool.my_size) / 2), location = (tempx,tempy,tempz))
            elif str(mytool.my_shapelist) == "Cylinder":
                bpy.ops.mesh.primitive_cylinder_add(radius = (float(mytool.my_size) / 2), depth=0.01, location = (tempx,tempy,tempz))
            ob = bpy.context.object
            me = ob.data
        ...
        if mytool.my_postprocesslist == "CalculateDGP":
           # Deselect all
            bpy.ops.object.select_all(action='DESELECT')
            for obj in bpy.context.visible_objects:
                custompropertyexists = bpy.data.objects[str(obj.name)].get('ObjectType') is not None
                if custompropertyexists == True:
                    if obj["ObjectType"] == "Camera":
                        obj.select_set(True)
            for obj in bpy.context.selected_objects:
                #Create Bat-file
                Tempbatfile = str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '\\glare.bat'
                BATFile=open(Tempbatfile,'w')
                BATFile.write("C:\Program Files (x86)\IDA ICE 5.2\bin\daylight\radiance\bin\rpict.exe -t 15 -vta -vp x y z -vd dx dy dz -vu 0 0 1 -vh 180 -vv 180 -vs 0 -vl 0 -af glare.amb -x 1600 -y 1200 -ps 8 -pt .15 -pj .6 -dj 0 -ds .5 -dt .5 -dc .25 -dr 0 -dp 128 -st .85 -ab 2 -aa .25 -ar 128 -ad 1024 -as 1024 -lr 4 -lw .05 ")#C:\Users\maxti\AppData\Local\Temp\idamod52\building1\DAYLIGHT\temp7072136\tmp\building1_0.oct > C:\Users\maxti\Downloads\building1.idm\glare.pic C:\Program Files (x86)\IDA ICE 5.2\bin\daylight\radiance\bin\evalglare.exe -c C:\Users\maxti\Downloads\building1.idm\glare.pic glare.pic > C:\Users\maxti\Downloads\building1.idm\glare.txt del C:\Users\maxti\Downloads\building1.idm\glare.amb")
                #BATFile.write('"' + str(bpy.path.abspath(os.path.dirname(mytool.IDAICEfolder_path))) + '\\bin\ice.exe"' + ' -X "' + str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '\\' + scriptname +'.txt' + '"')# + '\n' + 'Del ' + str(Tempbatfile))
                BATFile.close()
                #Edit Script so it can be run from BAT-file
        #        new_content = '(:SET doc_ (:call get-document "' + str(bpy.path.abspath(os.path.dirname(mytool.model_path))) + '"))'
        ...
        if mytool.my_postprocesslist == "CreateDayChart":
            #Charts generaton is not perfect, if lings with lower number than existing is deleted this will not be identified when creating new ones
            #Thickness is allways 4 m
            #Inner radius given by Size
            #Custom property added
            #Name consists of rins_and_hour to identify
            Rings = 0
            SegmentDepth = mytool.my_size/12.5
            Hours = 48
            R = mytool.my_size + SegmentDepth
            #See if segments exists, if so add new ring
            objs = []
            for o in bpy.data.objects:
                if o.name.startswith("Segment_"):
                    objs.append(o)
            if objs:  
                Rings = int(len(objs) / Hours)
            Angle = math.radians(90-7.5) #Blender starts apparently from X, not Y and adkust a little for pandas using mean values for previous half hour

            #Make one segment
            mesh = bpy.data.meshes.new("TimeSegment")  # add the new mesh
            obj = bpy.data.objects.new(mesh.name, mesh)
            col = bpy.data.collections["Collection"]
            col.objects.link(obj)
            bpy.context.view_layer.objects.active = obj
            point1X = 0
            point2X = 0
            point3X = (R + SegmentDepth) * math.cos(Angle)
            point4X = R * math.cos(Angle)
            point1Y = R
            point2Y = R + SegmentDepth
            point3Y = (R + SegmentDepth) * math.sin(Angle)
            point4Y = R * math.sin(Angle)
            verts = [(point1X, point1Y,  0), 
                     (point2X, point2Y,  0),
                     (point3X, point3Y,  0),
                     (point4X, point4Y,  0),
            ...
            faces = [[0, 1, 2, 3]]
            mesh.from_pydata(verts, edges, faces)
            bpy.context.active_object.name = 'Segment_' + str(Rings) + "_0"
            bpy.context.active_object[mytool.custompropertyname] = 0
            bpy.context.active_object.select_set(True)
            C = bpy.context
            src_obj = bpy.context.active_object
            #Rotate due to pandas time series
            #Save and duplicate and rotate
            TempHour = 1
            for _ in range(47): #No of hours per day to be plotted
                new_obj = src_obj.copy()
                new_obj.data = src_obj.data.copy()
                new_obj.animation_data_clear()
                C.collection.objects.link(new_obj)
                new_obj.name = 'Segment_' + str(Rings) + "_" + str((TempHour) )
                new_obj.rotation_euler[2] = src_obj.rotation_euler[2] - ((TempHour) * math.radians(7.5))
                TempHour = TempHour + 1
                new_obj.parent = src_obj
            ##Read data-------------------------------------------------------------------------------------
            #Check if vaiable exists, read it into pandas dataframe
            #For each selected zone
            src_obj.rotation_euler[2] = src_obj.rotation_euler[2] + math.radians(3.25)
            selection = bpy.context.selected_objects
            obs = []
            for obj in selection:
                if obj.type == 'MESH':
                    custompropertyexists = bpy.data.objects[str(obj.name)].get('ObjectType') is not None
                    if custompropertyexists == True:
                        if obj["ObjectType"] == "ImportedICEZone": #Only care about zones
                           #See if selected varaible is found in the zone folder
                            tempfilename = os.path.basename(mytool.model_path)
                            tempfilename = os.path.splitext(tempfilename)[0]
                            fp = zonefilepath = os.path.dirname(mytool.model_path) + "/" + tempfilename + '/' + str(obj.name)
                            #Open all prn-files in folder and look for first row.
                            for file in os.listdir(fp):
                                TotalZoneVolume = 0
                                if file.endswith(".prn"):
                                    with open(fp + "/" + file) as f:
                                        first_line = f.readline()
                                        if mytool.custompropertyname in first_line:
                                            #Make  hourly men value with optional filters
                                            #ignore first #
                                            prnheader = pd.read_csv(fp + "/" + file, delim_whitespace=True, header=None, engine='python', nrows=1)
                                            prnsrtipheader = prnheader.drop(0, axis=1).values.tolist()
                                            df = pd.read_csv(fp + "/" + file, skip_blank_lines=True, comment='#', delim_whitespace=True, header=None, engine='python', names=prnsrtipheader[0])
                                            #Create real time, right now allways 2025, should read from ICE
                                            df['datetime'] = pd.to_datetime('2025') \
                                             + df['time'].sub(1).apply(pd.Timedelta, unit='H') #,utc=True
                                            #For some reason add one hour
                                            df['datetime'] = df['datetime'] + pd.Timedelta(hours=1)
                                            df['Minute'] = df['datetime'].dt.minute
                                            df['Hour'] = df['datetime'].dt.hour 
                                            df['Dayname'] = df['datetime'].dt.dayofweek #Useful for filtering
                                            df['Month'] = df['datetime'].dt.month #Useful for filtering
                                            df['HourNo'] = df['Hour'] + np.where(((df['Minute']<30)), 0, 0.5) #If point in time smaller than 30 miutes else
                                            df = df.resample(rule='30Min', on='datetime').mean()
                                            df["HalfHourNo"] = df["HourNo"] #+ math.floor((df["Minute"] / 60) + 1)
                                            #Delete periods based upon fillters
                                            if str(mytool.my_timefilteroptions) == "SUMMER":
                                                df = df[df.Month != 0]
                                                df = df[df.Month != 1]
                                                df = df[df.Month != 2]
                                                df = df[df.Month != 3]
                                                ...
                                                df = df[df.Month != 10]
                                                df = df[df.Month != 11]
                                            elif str(mytool.my_timefilteroptions) == "SPRING": #Mars-May
                                                df = df[df.Month != 0]
                                                df = df[df.Month != 1]
                                                df = df[df.Month != 5]
                                                df = df[df.Month != 6]
                                                ...
                                                df = df[df.Month != 10]
                                                df = df[df.Month != 11]
                                            elif str(mytool.my_timefilteroptions) == "WINTER":
                                                df = df[df.Month != 2]
                                                df = df[df.Month != 3]
                                                df = df[df.Month != 4]
                                                df = df[df.Month != 5]
                                                ...
                                                df = df[df.Month != 9]
                                                df = df[df.Month != 10]
                                            elif str(mytool.my_timefilteroptions) == "AUTUMN": #"
                                                df = df[df.Month != 0]
                                                df = df[df.Month != 1]
                                                df = df[df.Month != 2]
                                                df = df[df.Month != 3]
                                                ...
                                                df = df[df.Month != 7]
                                                df = df[df.Month != 11]
                                            #Make a list out of every half hour based upon minut and hour and make mean value
                                            halfhourlist = df.groupby(['HalfHourNo']).mean()
                                            print(halfhourlist)
                                            #sumweekdaysyear = df.groupby(df['datetime'].dt.hour)[mytool.custompropertyname].mean()
                                            TotalZoneVolume = TotalZoneVolume + obj["Zone volume"]
                                            TempRow = 0                               
                                            for _ in range(48):
                                                Tempname = 'Segment_' + str(Rings) + "_" + str(TempRow)
                                                bpy.data.objects[Tempname][mytool.custompropertyname] = bpy.data.objects[Tempname][mytool.custompropertyname] + halfhourlist.loc[TempRow/2, mytool.custompropertyname]*TotalZoneVolume + obj["Zone volume"]
                                                #Save what filter that was used if any
                                                bpy.data.objects[Tempname]["Filter"] = str(mytool.my_timefilteroptions)
                                                TempRow = TempRow + 1
                                            TempVar = 0
                                            #Normalize the alread saved values based upon zone volume (ugly solution, I know)
                                            for _ in range(48):
                                                Tempname = 'Segment_' + str(Rings) + "_" + str(TempVar)
                                                bpy.data.objects[Tempname][mytool.custompropertyname] = bpy.data.objects[Tempname][mytool.custompropertyname] / TotalZoneVolume
                                                TempVar = TempVar + 1
            #rotate acording to north
            src_obj.rotation_euler[2] = src_obj.rotation_euler[2] - bpy.context.scene.sun_pos_properties.north_offset
        if mytool.my_postprocesslist == "CreateSkyDome":
            
            #Override IDA ICE sky for now (this variable is currently found in CreateSunPath)
            ShadingCalculationGrid = 10
            bpy.ops.mesh.primitive_uv_sphere_add(radius=mytool.my_size, segments=int(360/ShadingCalculationGrid), ring_count=int(360/ShadingCalculationGrid), enter_editmode=False, align='WORLD', location=(0, 0, 0), rotation=(0, 0, 1.5708), scale=(1, 1, 1))
            bpy.context.active_object.name = 'SkyDome'
            #Connect to sun if available
            sunexists = bpy.context.scene.objects.get("SunSphere")
            if sunexists:
                bpy.data.objects['SkyDome'].parent = bpy.data.objects['SunSphere']
            objectToSelect = bpy.data.objects["SkyDome"]
            objectToSelect.select_set(True)    
            bpy.context.view_layer.objects.active = objectToSelect
            ob = bpy.data.objects['SkyDome']
            bpy.ops.object.mode_set(mode = 'EDIT')       
            bpy.ops.mesh.select_all(action = 'SELECT')
            #Split dome in individual parts
            bpy.ops.mesh.edge_split()
            bpy.ops.mesh.select_all(action = 'SELECT')
            #Separate the parts
            bpy.ops.mesh.separate(type='LOOSE')
            bpy.ops.object.editmode_toggle()
            #Change origin of individual parts
            bpy.ops.object.origin_set(type='ORIGIN_CENTER_OF_MASS', center='MEDIAN')
            #Remove objects below z=0
            for obj in bpy.context.selected_objects:
                if obj.location[2] > 0:
                    obj.select_set(False)
                obj.parent = bpy.data.objects['SkyDome']
            bpy.data.batch_remove(bpy.context.selected_objects)
        
        if mytool.my_postprocesslist == "CreateSunPath":
            #Get data from idm-file, save all locations with data and determine afterwards wich to use
            Climate = []
            Latitude = []
            Longitude = []
            Timezone = []
            LineNumber = 0
            Lastsavedlinenumber = 0 #Useful to see how things are connected without LISP (if the lines are near each other)
            ShadingCalculationGrid = 15 #Default if none is set
            Orientation = 0 #Default
            with open(mytool.model_path, 'r') as f:
                for line in f:
                    LineNumber = LineNumber + 1
                    #For each location, save name lat, long and time zone
                    #Find out what location that is used
                    if '(LOCATION :N' in line:
                        Lastsavedlinenumber = LineNumber
                        TempLine = line.split('"')[1::2]
                        TempLine = TempLine[0]
                        Climate.append(TempLine)
                        #print (Climate)
                    if 'LATITUDE' in line:
                        if LineNumber - Lastsavedlinenumber < 7:
                            TempLine = line.split(':V ')[1::2]
                            TempLine = TempLine[0]
                            TempLine = TempLine.replace(")\n", "")
                            Latitude.append(TempLine)
                            #print (Latitude)
                    ...
                    if 'TIME_ZONE' in line:
                        if LineNumber - Lastsavedlinenumber < 7:
                            ...
                            TempLine = TempLine[0]
                            TempLine = TempLine.replace(")\n", "")
                            Timezone.append(TempLine)
                            #print (Timezone)
                    if ':RES :N LOCATION' in line:
                        TempLine = line.split('"')[1::2]
                        TempLine = TempLine[0]
                        UsedClimate = TempLine
                    if 'ORIENTATION' in line:
                        TempLine = line.split(':V ')[1::2]
                        TempLine = TempLine[0]
                        TempLine = TempLine.replace("))\n", "")
                        Orientation = TempLine
                    if 'SHADING_CALCULATION_GRID' in line:
                        TempLine = line.split(':V ')[1::2]
                        TempLine = TempLine[0]
                        TempLine = TempLine.replace("))\n", "")
                        ShadingCalculationGrid = TempLine
            for i in range(len(Climate)): #Based upon UsedClimate, determine what location that is used in the model
                if Climate[i] == UsedClimate:
                    Latitude = Latitude[i]
                    Longitude = Longitude[i]
                    Timezone = Timezone[i]
            #print ("Shading: " + str(ShadingCalculationGrid))
            bpy.context.scene.sun_pos_properties.latitude = float(Latitude)
            bpy.context.scene.sun_pos_properties.longitude = float(Longitude)
            bpy.context.scene.sun_pos_properties.north_offset = -1*float(Orientation)
            bpy.context.scene.sun_pos_properties.UTC_zone = float(Timezone)
            bpy.context.scene.sun_pos_properties.show_north = True
            bpy.context.scene.sun_pos_properties.show_analemmas = True
            bpy.context.scene.sun_pos_properties.show_surface = True
            
            #Read solar data if path and file is available. Note that there is a big chance that the file does not fit with the model
            #Datafound = False
            #Check if file exists, read it into pandas dataframe
#            tempfilename = os.path.basename(mytool.model_path)
#            tempfilename = os.path.splitext(tempfilename)[0]
#            fp = zonefilepath = os.path.dirname(mytool.model_path) + "/" + tempfilename + '/BLDCTRL.OUTPUT-FILE.prn'
#            if os.path.isfile(fp) == True:
#                #Read file
#                #ignore first #
#                prnheader = pd.read_csv(fp, delim_whitespace=True, header=None, engine='python', nrows=1)
#                prnsrtipheader = prnheader.drop(0, axis=1).values.tolist()
#                df = pd.read_csv(fp, skip_blank_lines=True, comment='#', delim_whitespace=True, header=None, engine='python', names=prnsrtipheader[0])
#                #print (prndata)
#            #print (prndata)
#            #Create real time, right now allways 2025, should read from ICE
#            df['datetime'] = pd.to_datetime('2025') \
#             + df['time'].sub(1).apply(pd.Timedelta, unit='H')
#            #For some reason add one hour
#            df['datetime'] = df['datetime'] + pd.Timedelta(hours=1)
#            #Delete unwanted data
#            df = df.drop('order', axis=1)
#            df = df.drop('time', axis=1)
#            #Move order to make it easear to see
#            df = df[ ['datetime'] + [ col for col in df.columns if col != 'datetime' ] ]
#            
#            #mean_hourly = df.resample('60T', on="datetime")['idirnorm'].mean()
#            sum_hourly = df.resample('60T', on="datetime")['idirnorm'].sum()
##            sumweekdays1 = sum_hourly.groupby(sum_hourly['datetime'].dt.hour)['idirnorm'].sum()
##            print (sumweekdays1)
#            sumweekdaysyear = df.groupby(df['datetime'].dt.hour)['idirnorm'].mean()
#            
            #Set orientation after all is done
            print (str(Orientation))
            bpy.context.scene.sun_pos_properties.north_offset = math.radians(float(Orientation))

            #Onemonth
            #print (sumweekdays2)
            #january = df[df['datetime'].dt.month == 1]
            #sumweekdaysyear = january.groupby(january['datetime'].dt.hour)['idirnorm'].mean()
            #print (sumweekdaysyear)
            
#            #Create a small dummy sun with few segments to save memory
#            bpy.ops.mesh.primitive_uv_sphere_add(segments=6, ring_count=6, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(0.5, 0.5, 0.5))
#            bpy.context.active_object.name = 'SunSphere'
#            C = bpy.context
#            src_obj = bpy.context.active_object  
#            for index, row in prndata.iterrows():
#                if (row['time']).is_integer():
#                    if row['elevsun'] > 0:
#                        #Copy dummy sun for inceresing speed
#                        new_obj = src_obj.copy()
#                        new_obj.data = src_obj.data.copy()
#                        new_obj.animation_data_clear()
#                        C.collection.objects.link(new_obj)
#                        #Calculate position
#                        #new_obj.location = bpy.data.objects["Sun"].location
#                        #Populate with data
#                        new_obj["Elevation"] = row['elevsun']
#                        new_obj["Azimut"] =  row['azimut']
#                        new_obj["Hour"] = row['time']
#                        new_obj["IDirNorm"] =  row['idirnorm']
#                        new_obj["IDiffHor"] = row['idifhor']
#                        new_obj["TAir"] = row['tair']
#                        x = 50 * math.sin(math.radians(row['elevsun'])) * math.cos(math.radians(row['azimut']))
#                        y = 50 * math.sin(math.radians(row['elevsun'])) * math.sin(math.radians(row['azimut']))
#                        z = 50 * math.cos(math.radians(row['elevsun']))
#                        new_obj.location = (x,y,z)
#                        new_obj["X"] = x
#                        new_obj["Y"] = y
#                        new_obj["Z"] = z
#                    new_obj["WindX"] = row['windx']
#                    new_obj["WindY"] = row['windy']
            
            #Create suns for the 21th day each 12 months above horizon
            #Create sun paths for each hour
            #Save paths for each sun
#            PreviousHourValueX = 0
#            PreviousHourValueY = 0
#            PreviousHourValueZ = 0
#            CurrentHourValueX = 0
#            CurrentHourValueY = 0
#            CurrentHourValueZ = 0
#            hour = 21 * 24 #Start the 21st
#            month = 1
#            for _ in range(24): #No of months per year to be plotted
#                daylyhour = 0
#                for _ in range(12): #No of half hours per day
#                    bpy.context.scene.sun_pos_properties.time = hour
#                    #Only plot suns above horizon
#                    daylyhour = daylyhour + 1
#                    CurrentHourValueX = bpy.data.objects["Sun"].location[0]
#                    CurrentHourValueY = bpy.data.objects["Sun"].location[1]
#                    CurrentHourValueZ = bpy.data.objects["Sun"].location[2]
#                    if bpy.data.objects["Sun"].location[2] > 0:
#                        #Copy dummy sun for inceresing speed
#                        new_obj = src_obj.copy()
#                        new_obj.data = src_obj.data.copy()
#                        new_obj.animation_data_clear()
...
#                        if Datafound == True:
#                            HourRow = df[df['Time'] == hour]
#                            new_obj["IDirNorm"] =  HourRow.iloc[0]['IDirNorm']
#                            new_obj["IDiffHor"] = HourRow.iloc[0]['IDiffHor']
#                            new_obj["TAir"] = HourRow.iloc[0]['TAir']
#                            new_obj["RelHum"] = HourRow.iloc[0]['RelHum']
#                            new_obj["SkyCover"] =  HourRow.iloc[0]['SkyCover']
#                            new_obj["Precipitation"] = HourRow.iloc[0]['Precipitation']
#                        #Connect suns to sinngle point
#                        new_obj.parent = bpy.data.objects['SunSphere']
#                        #Draw sun paths and connect to sun in single point
#                        if PreviousHourValueZ != 0 and CurrentHourValueX != 0: 
#                            DrawCylinderBetween(PreviousHourValueX,PreviousHourValueY,PreviousHourValueZ,CurrentHourValueX,CurrentHourValueY,CurrentHourValueZ,3,0.05)
#                            bpy.context.active_object.name = 'Sunpath'
#                            bpy.context.active_object.parent = bpy.data.objects['SunSphere']
#                        PreviousHourValueX = CurrentHourValueX
#                        PreviousHourValueY = CurrentHourValueY
#                        PreviousHourValueZ = CurrentHourValueZ
#                    else:
#                        CurrentHourValueX = 0
#                        CurrentHourValueY = 0
#                        CurrentHourValueZ = 0                    
...
#                PreviousHourValueY = 0
#                PreviousHourValueZ = 0
            #Delete dummy sun sphere and sun
            
#            object_to_delete = bpy.data.objects['SunSphere']
#            bpy.data.objects.remove(object_to_delete, do_unlink=True)
            #object_to_delete = bpy.data.objects['Sun']
#        if mytool.my_postprocesslist == "CreateSunPath": #Old version based upon Sun Position plugin
#            #Get data from idm-file, save all locations with data and determine afterwards wich to use
#            Climate = []
#            Latitude = []
#            Longitude = []
...
#            #Read solar data if path and file is available. Note that there is a big chance that the file does not fit with the model
#            Datafound = False
#            if mytool.IDAICETempfolder_path != "":
#                #Check if file exists
#                fp = str(bpy.path.abspath(os.path.dirname(mytool.IDAICETempfolder_path))) + '\\CLIMATE_.PRN'
#                if os.path.isfile(fp) == True:
#                    #Read file
#                    fp = str(bpy.path.abspath(os.path.dirname(mytool.IDAICETempfolder_path))) + '\\CLIMATE_.PRN'
#                    df = pd.read_csv(fp, delim_whitespace=True)  
#                    Datafound = True
#            #Create sun and link it, it should always be called Sun
#            bpy.ops.object.light_add(type='SUN', radius=1, align='WORLD', location=(0, 0, 0), scale=(1, 1, 1))
#            bpy.context.active_object.name = 'Sun'
#            #Link the sun in the sun path extension
#            bpy.context.scene.sun_pos_properties.sun_object = bpy.data.objects["Sun"]
#            #Create a small dummy sun
#            bpy.ops.mesh.primitive_uv_sphere_add(segments=6, ring_count=6, enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(0.5, 0.5, 0.5))
#            bpy.context.active_object.name = 'SunSphere'
#            C = bpy.context
#            src_obj = bpy.context.active_object  
...
#        row.prop(mytool, "my_prismaticheight")
        ...
        if bpy.context.scene.my_tool.my_exportobjectlist == "ExternalObjects":
            ...
            row.enabled = False
        #row.prop(mytool, "my_deleteCADbool")
...
class OBJECT_PT_ICEBridgePanel5(Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row()   # A new row
        row.prop(mytool, "my_timefilteroptions")
...
#Funktion to draw cylinder between 2 points, useful for sunpaths
def DrawCylinderBetween(x1, y1, z1, x2, y2, z2, v, r): 
